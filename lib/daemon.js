...
function DaemonInterface(daemons, logger) {
    ...
    if (!logger)
    {
        logger = function(severity, message) { console.log(severity + ': ' + message); };
    }
    ...
    function performHttpRequest(instance, jsonData, callback) {
        ...
        var parseJson = function (res, data) {
            ...
            if (res.statusCode !== 200 && res.statusCode !== 500) {
                ...
                logger('warn', 'Daemon returned unexpected return code ' + res.statusCode + ', data = ' + JSON.stringify(data));
                return;
            }
